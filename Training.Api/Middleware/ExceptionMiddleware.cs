...
public class ExceptionMiddleware
{
    ...
    private Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        response.StatusCode = exception switch
        {
            ...
            InvalidOpenSessionException => StatusCodes.Status400BadRequest,
    ...
    private static string GetErrorCode(Exception exception)
    {
        return exception switch
        {
            ...
            InvalidOpenSessionException => "invalid_open_session",
    ...
    private static string GetErrorMessage(Exception exception)
    {
        return exception switch
        {
            ...
            EventNotFoundException => "Evenement introuvable",
            ...
            InvalidOpenSessionException => "Session ouverte invalide",
